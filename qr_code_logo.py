import qrcode
import PIL.Image
from tkinter import Tk, Label, Entry, Button, Frame, StringVar, W, E, N, S, filedialog
...
Label (frame, text='QR Color', bg='#f25252').grid(row=2, column=0)
qr_color = Entry(frame)
qr_color.grid(row=2, column=1)
...
btn.grid(row=3, columnspan=3, pady=10)
